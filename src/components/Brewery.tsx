    ...
    return (
        <div className={'Brewery'}>
            ...
            <div className="brewery-card">
                ...
                {brewery.latitude === null ? '' : <span className="maps">Open in maps: <a target="_blank" rel="noreferrer" href={'https://maps.google.com/?q='+brewery.latitude+','+brewery.longitude}>{brewery.latitude}, {brewery.longitude}</a></span>}
            </div>
